...
void loop() {
  ...
  messageArray[4] = (int8_t)(measurementInt & 0xFF); // use *addr instead of measurementInt to send floats
  messageArray[5] = (int8_t)(measurementInt >> 8) & 0xFF; // >> shift 8 bits
  messageArray[6] = (int8_t)(measurementInt >> 16) & 0xFF; // >> shift 16 bits
  messageArray[7] = (uint8_t)(measurementInt >> 24) & 0xFF; // >> shift 24
